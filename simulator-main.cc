...
class SimulatorMain
{
  public:
    ...
    void SetRoutingVerbose (Ptr<GURoutingProtocol> routingProtocol, std::vector<std::string> tokens);
    void SetApplicationVerbose (Ptr<GUApplication> application, std::vector<std::string> tokens);
...
void
SimulatorMain::SetApplicationVerbose (Ptr<GUApplication> application, std::vector<std::string> tokens)
{
  if (tokens.size() != 2)
    return;
  std::vector<std::string>::iterator iterator = tokens.begin();
...
void
SimulatorMain::SetRoutingVerbose (Ptr<GURoutingProtocol> routingProtocol, std::vector<std::string> tokens)
{
  if (tokens.size() != 2)
    return;
  std::vector<std::string>::iterator iterator = tokens.begin();
